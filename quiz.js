...
titulo.textContent = "Revista d'Arc";
...
function fimDoJogo() {
  ...
  instrucoes.textContent =
    "Fim de Jogo! Você leu atentamente à revista? Sua pontuação: " + pontos + " ponto" + s + ". Escolha uma opção:";
  instrucoes.classList.add("placar");

  // OCULTAR O ARTICLE DA QUESTAO
  questao.style.display = "none";
  setTimeout(function () {
    instrucoes.textContent = "Escolha a opção: ";
  }, 7000);
  

setTimeout(function () {
  document.body.innerHTML = "<h1 class ='game-over'>Fim de jogo...Temos algumas perguntas para você!</h1>,<a class='clicar' href='index.html'>Não clique aqui!!!!!</a>, <a> "; 
}, 5000);
}